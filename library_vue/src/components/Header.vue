        ...
        <ul class="navbar-nav ">
          <li class="nav-item">
            <router-link class="nav-link d-flex align-items-center" to="/">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-book me-1"
                   viewBox="0 0 16 16">
                <path
          ...
          <li class="nav-item" v-if="isLoggedIn">
            <router-link class="nav-link d-flex align-items-center" to="/orders">
